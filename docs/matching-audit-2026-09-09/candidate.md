...
The normal launcher is `/home/bts/.local/bin/LEZU`. Its target and the exact source commit are recorded in `/home/bts/.local/state/LEZU/local-install-20260909/installed-candidate.json`.
