# LEZU 1.6 release record

[LEZU 1.6.0](https://github.com/btsouth/LEZU/releases/tag/v1.6.0) was
...
[final release workflow](https://github.com/btsouth/LEZU/actions/runs/33939075319).
...
- Start with `./build/release/LEZU --couch` and navigate without a mouse.
...
- Launch a Steam game and any available native or Windows GOG game. Press the
  face buttons, Start, and directional controls while playing: LEZU must not
  regain focus or change its library. Return to LEZU and check navigation.
...
[PR #28](https://github.com/btsouth/LEZU/pull/28) merged as `2de11d5`. It
