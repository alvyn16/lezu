...
ApplicationWindow {
    ...
    readonly property bool libraryScanning: (SteamLibrary ? SteamLibrary.scanning : false)
                                            || (typeof EpicLibrary !== "undefined" && EpicLibrary ? EpicLibrary.scanning : false)
                                            || (typeof GogLibrary !== "undefined" && GogLibrary ? GogLibrary.scanning : false)
    ...
    function rescanLibraries() {
        ...
        if (typeof EpicLibrary !== "undefined" && EpicLibrary && Preferences.epicEnabled) EpicLibrary.refresh()
        if (typeof GogLibrary !== "undefined" && GogLibrary && Preferences.gogEnabled) GogLibrary.refresh()
    ...
    ManualGameEditor {
        ...
        onRemoved: {
            root.manualEditorOpen = false
            root.closeDetails()
            root.showToast("Removed from Lezu. Game files were kept.")
        }
    }
        ...
        ColumnLayout {
            ...
            LibraryView {
                ...
                emptyTitle: root.emptyTitleForFilters() !== "" ? root.emptyTitleForFilters()
                            : root.emptySourceFilter === "Epic" && typeof EpicLibrary !== "undefined" && EpicLibrary && !EpicLibrary.epicDetected
                            ? "Epic Games Launcher was not found"
                            : root.emptySourceFilter === "GOG" && typeof GogLibrary !== "undefined" && GogLibrary && !GogLibrary.gogDetected
                            ? "GOG was not found"
                ...
                emptyMessage: Library.searchText !== ""
                              ...
                              : root.emptySourceFilter === "Epic" && typeof EpicLibrary !== "undefined" && EpicLibrary && EpicLibrary.errorText.length > 0
                              ? EpicLibrary.errorText
                              : root.emptySourceFilter === "GOG" && typeof GogLibrary !== "undefined" && GogLibrary && GogLibrary.errorText.length > 0
                              ? GogLibrary.errorText
                              ...
                              : (Library.sourceFilters.length === 0 || Library.sourceFilters.indexOf("Steam") >= 0)
                                ...
                                : "Install a game in Steam, Epic, GOG, or a supported emulator (DuckStation, PCSX2, RPCS3, RetroArch, PPSSPP, Project64, melonDS, Azahar), then rescan your library."
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Text {
                Layout.fillWidth: true
                text: "Choose only another installation of the same game. Lezu will keep every launch target."
                color: Theme.mutedText
                font.family: Theme.fontFamily
                font.pixelSize: 10
                wrapMode: Text.Wrap
    ...
    ActionMenu {
        ...
        Flow {
            ...
            GlassButton {
                id: epicSourceButton
                objectName: "epicSourceButton"
                text: "EPIC"
                compact: true
                visible: Preferences.epicEnabled
                property string sourceName: "Epic"
                selected: Library.sourceFilters.indexOf("Epic") >= 0
                onClicked: {
                    Library.sourceFilters = ["Epic"]
                    libraryView.currentIndex = Library.rowCount() > 0 ? 0 : -1
                }
                onSecondaryClicked: {
                    Library.toggleSource("Epic")
                    libraryView.currentIndex = Library.rowCount() > 0 ? 0 : -1
                }
            }
            GlassButton {
