            ...
            ColumnLayout {
                ...
                Repeater {
                    model: [
                        ...
                        { name: "EPIC", enabled: Preferences.epicEnabled,
                          status: typeof EpicLibrary !== "undefined" && EpicLibrary ? EpicLibrary.statusText : "Unavailable",
                          error: typeof EpicLibrary !== "undefined" && EpicLibrary ? EpicLibrary.errorText : "",
                          paths: typeof EpicLibrary !== "undefined" && EpicLibrary ? EpicLibrary.detectedPaths : [],
                          lastScan: typeof EpicLibrary !== "undefined" && EpicLibrary ? EpicLibrary.lastScan : 0 },
                        { name: "GOG", enabled: Preferences.gogEnabled,
                          status: typeof GogLibrary !== "undefined" && GogLibrary ? GogLibrary.statusText : "Unavailable",
                          error: typeof GogLibrary !== "undefined" && GogLibrary ? GogLibrary.errorText : "",
                          paths: typeof GogLibrary !== "undefined" && GogLibrary ? GogLibrary.detectedPaths : [],
                          lastScan: typeof GogLibrary !== "undefined" && GogLibrary ? GogLibrary.lastScan : 0 },
                        ...
                        RowLayout {
                            ...
                            GlassButton {
                                ...
                                onClicked: {
                                    ...
                                    } else if (modelData.name === "EPIC") {
                                        Preferences.epicEnabled = !Preferences.epicEnabled
                                        nowEnabled = Preferences.epicEnabled
                                        if (Preferences.epicEnabled && typeof EpicLibrary !== "undefined" && EpicLibrary) EpicLibrary.refresh()
                                    } else if (modelData.name === "GOG") {
                                        Preferences.gogEnabled = !Preferences.gogEnabled
                                        nowEnabled = Preferences.gogEnabled
                                        if (Preferences.gogEnabled && typeof GogLibrary !== "undefined" && GogLibrary) GogLibrary.refresh()
                            ...
                            GlassButton {
                                ...
                                onClicked: {
                                    if (modelData.name === "STEAM") SteamLibrary.refresh()
                                     ...
                                     else if (modelData.name === "EPIC" && typeof EpicLibrary !== "undefined" && EpicLibrary) EpicLibrary.refresh()
                                     else if (modelData.name === "GOG" && typeof GogLibrary !== "undefined" && GogLibrary) GogLibrary.refresh()
                ...
                ColumnLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        text: "Add a native game or an executable that no launcher reports. Removing one from Lezu never deletes its files."
                        color: Theme.mutedText
                        font.family: Theme.fontFamily
                        font.pixelSize: 11 * settingsPanel.uiScale
                        wrapMode: Text.Wrap
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                ...
                                Layout.fillWidth: true
                                readonly property string scanState: typeof GogLibrary !== "undefined" && GogLibrary
                                    ? GogLibrary.statusText + GogLibrary.errorText : ""
                    ...
                    TextField {
                        ...
                        property bool controllerNavigation: host.couchMode || (Controller !== null && Controller.driving)
                        Layout.fillWidth: true
                        placeholderText: "C:/path/to/GOG games"
                ...
                Text {
                    Layout.fillWidth: true
                    text: "Session tracking runs in a background worker thread. Paused emulator time counts. Imported and recorded totals can overlap; they are not simply added together. Switching recording off keeps your history and displays imported time."
                    color: Theme.mutedText
                    font.family: Theme.fontFamily
                    font.pixelSize: 11 * settingsPanel.uiScale
                    wrapMode: Text.Wrap
...
GlassButton {
                ...
                Text {
                    Layout.fillWidth: true
                    text: "Moonlight shows Sunshine's app list. Lezu can add itself next to Steam Big Picture and one app per installed game with its cover. Sunshine reads the list when it starts, so restart it after changes."
                    color: Theme.mutedText
                    font.family: Theme.fontFamily
                    font.pixelSize: 9 * settingsPanel.uiScale
                    wrapMode: Text.Wrap
                ...
                Repeater {
                    ...
                    GlassButton {
                        compact: true
                        text: "PROJECT"
                        onClicked: Qt.openUrlExternally("https://github.com/alvyn16/lezu")
                    }
                    GlassButton {
                        compact: true
                        text: "REPORT ISSUE"
                        onClicked: Qt.openUrlExternally("https://github.com/alvyn16/lezu/issues/new/choose")
                    }
                    Item { Layout.fillWidth: true }
                }
                }
                ...
                Text {
                    Layout.fillWidth: true; wrapMode: Text.Wrap
                    text: "Lezu backup archives contain organization and preferences, not emulator saves. Save protection keeps separate local copies. Clearing downloaded artwork does not remove game files."
