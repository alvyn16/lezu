...
ColumnLayout {
    ...
    ColumnLayout {
        ...
        spacing: 10
        Text { Layout.fillWidth: true; wrapMode: Text.Wrap; color: Theme.mutedText; text: "Browse RomM games from a locally mounted library. Use a Client API Token with roms.read access. Lezu never downloads or changes server files." }
        TextField {
