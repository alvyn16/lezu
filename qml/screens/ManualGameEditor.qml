...
Rectangle {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Text {
                Layout.fillWidth: true
                text: "Choose an executable or script, review its launch details, then save. Games can also be added through Steam, Epic, or GOG."
                wrapMode: Text.Wrap
                color: Theme.mutedText
                font.family: Theme.fontFamily
            ...
            Text {
                ...
                text: "Remove this entry from Lezu? The game files will stay where they are."
                wrapMode: Text.Wrap
                color: Theme.foreground
                font.family: Theme.fontFamily
                font.pixelSize: 12 * editor.uiScale
            ...
            EditorButton {
                ...
                text: editor.confirmingRemoval ? "CONFIRM REMOVAL" : "REMOVE FROM LEZU"
                onClicked: {
