...
Item {
                ...
                Text {
                    ...
                    text: {
                        ...
                        values.push(seconds > 0 ? (root.game.playtimeText || root.game.hours + "h") + " played"
                                               : root.game.lastPlayed > 0 ? "Less than a minute recorded" : "Not played in Lezu")
    ...
    ActionMenu {
        ...
        MenuAction {
            ...
            visible: ["Steam", "Epic", "GOG", "RetroArch", "PCSX2", "Ryujinx", "shadPS4", "Cemu", "Dolphin", "Battle.net"].indexOf(root.selectedInstallation.source) >= 0
    ...
    ActionMenu {
        ...
        Text {
            ...
            text: SessionRecorderStatus && SessionRecorderStatus.enabled
                  ? "Recent sessions recorded locally by Lezu."
