...
const QVector<ConsoleDefinition>& definitions() {
  static const QVector<ConsoleDefinition> consoles = {
      ...
      {.id = QStringLiteral("n64"),
       ...
       .standaloneExecutables = {QStringLiteral("Project64"), QStringLiteral("project64"),
                                 QStringLiteral("mupen64plus")},
      ...
      {.id = QStringLiteral("psx"),
       ...
       .extensions = {QStringLiteral("cue"), QStringLiteral("chd"), QStringLiteral("pbp"),
                      QStringLiteral("iso")},
       .standaloneExecutables = {QStringLiteral("duckstation-qt-x64-ReleaseLTCG"),
                                 QStringLiteral("duckstation-qt"), QStringLiteral("duckstation")},
      ...
      {.id = QStringLiteral("ps2"),
       ...
       .standaloneExecutables = {QStringLiteral("pcsx2-qt"), QStringLiteral("pcsx2")},
       .retroArchCores = {QStringLiteral("pcsx2_libretro")},
       .dedicatedSource = true},
      {.id = QStringLiteral("ps3"),
       .displayName = QStringLiteral("PlayStation 3"),
       .libretroPlaylist = QStringLiteral("Sony - PlayStation 3"),
       .aliases = {QStringLiteral("PlayStation 3"), QStringLiteral("PS3")},
       .folderNames = {QStringLiteral("ps3")},
       .extensions = {QStringLiteral("pkg"), QStringLiteral("iso"), QStringLiteral("bin")},
       .standaloneExecutables = {QStringLiteral("rpcs3")},
       .retroArchCores = {},
       .dedicatedSource = true},
      {.id = QStringLiteral("psp"),
       .displayName = QStringLiteral("PlayStation Portable"),
       .libretroPlaylist = QStringLiteral("Sony - PlayStation Portable"),
       .aliases = {QStringLiteral("PlayStation Portable"), QStringLiteral("PSP")},
       .folderNames = {QStringLiteral("psp")},
       .extensions = {QStringLiteral("iso"), QStringLiteral("cso"), QStringLiteral("chd"),
                      QStringLiteral("pbp")},
       .standaloneExecutables = {QStringLiteral("PPSSPPWindows64"), QStringLiteral("PPSSPPWindows"),
                                 QStringLiteral("ppsspp")},
       .retroArchCores = {QStringLiteral("ppsspp_libretro")}},
      {.id = QStringLiteral("nds"),
       .displayName = QStringLiteral("Nintendo DS"),
       .libretroPlaylist = QStringLiteral("Nintendo - Nintendo DS"),
       .aliases = {QStringLiteral("Nintendo DS"), QStringLiteral("NDS"), QStringLiteral("DS")},
       .folderNames = {QStringLiteral("nds"), QStringLiteral("ds")},
       .extensions = {QStringLiteral("nds"), QStringLiteral("dsi")},
       .standaloneExecutables = {QStringLiteral("melonDS"), QStringLiteral("desmume")},
       .retroArchCores = {QStringLiteral("melonds_libretro"), QStringLiteral("desmume_libretro")}},
      {.id = QStringLiteral("3ds"),
       .displayName = QStringLiteral("Nintendo 3DS"),
       .libretroPlaylist = QStringLiteral("Nintendo - Nintendo 3DS"),
       .aliases = {QStringLiteral("Nintendo 3DS"), QStringLiteral("3DS")},
       .folderNames = {QStringLiteral("3ds")},
       .extensions = {QStringLiteral("3ds"), QStringLiteral("cia"), QStringLiteral("cxi")},
       .standaloneExecutables = {QStringLiteral("azahar"), QStringLiteral("azahar-qt"),
                                 QStringLiteral("citra-qt"), QStringLiteral("citra")},
       .retroArchCores = {QStringLiteral("citra_libretro")}},
