...
FaugusGameModel::FaugusGameModel(const QString& LEZUDatabasePath, QObject* parent)
    : QAbstractListModel(parent),
      m_connectionName(QStringLiteral("LEZU-faugus-%1").arg(reinterpret_cast<quintptr>(this))) {
