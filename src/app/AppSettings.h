...
class AppSettings final : public QObject {
  ...
  Q_PROPERTY(bool epicEnabled READ epicEnabled WRITE setEpicEnabled NOTIFY sourcesChanged)
...
public:
  ...
  [[nodiscard]] bool epicEnabled() const;
  void setEpicEnabled(bool value);
