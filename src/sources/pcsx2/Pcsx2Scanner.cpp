...
#ifdef Q_OS_WIN
  const QString winPcsx2 = WinPaths::pcsx2ConfigDir();
  if (!winPcsx2.isEmpty()) {
    candidates.append(winPcsx2);
  }
  candidates.append(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + QStringLiteral("/PCSX2"));
#else
